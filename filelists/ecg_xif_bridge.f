# Tap nguon cua `ecg_xif_bridge`, SINH RA tu dong lenh da khai trien cua dich
# `make lint-rtl` (xem tools/gen_filelists.py). DUNG SUA TAY: Makefile la
...
#     -f filelists/ecg_xif_bridge.f --top-module ecg_xif_bridge
include/ecg_pkg.sv
