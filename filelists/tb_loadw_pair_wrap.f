# Tap nguon cua `tb_loadw_pair_wrap`, SINH RA tu dong lenh da khai trien cua dich
# `make sim-loadw-pair` (xem tools/gen_filelists.py). DUNG SUA TAY: Makefile la
...
#     -f filelists/tb_loadw_pair_wrap.f --top-module tb_loadw_pair_wrap
include/ecg_pkg.sv
tb/tb_loadw_pair_wrap.sv
