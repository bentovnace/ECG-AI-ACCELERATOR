# Tap nguon cua `ecg_desc`, SINH RA tu dong lenh da khai trien cua dich
# `make sim-desc` (xem tools/gen_filelists.py). DUNG SUA TAY: Makefile la
...
#     -f filelists/ecg_desc.f --top-module ecg_desc
include/ecg_pkg.sv
src/coproc/ecg_desc.sv
