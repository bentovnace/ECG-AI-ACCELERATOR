# Tap nguon cua `ecg_uart`, SINH RA tu dong lenh da khai trien cua dich
# `make sim-uart` (xem tools/gen_filelists.py). DUNG SUA TAY: Makefile la
...
#     -f filelists/ecg_uart.f --top-module ecg_uart
src/soc/ecg_uart.sv
