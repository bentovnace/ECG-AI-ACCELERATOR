# Tap nguon cua `ecg_cvxif`, SINH RA tu dong lenh da khai trien cua dich
# `make sim-cvxif` (xem tools/gen_filelists.py). DUNG SUA TAY: Makefile la
...
#     -f filelists/ecg_cvxif.f --top-module ecg_cvxif
include/ecg_pkg.sv
