# Tap nguon cua `tb_xif_kill_wrap`, SINH RA tu dong lenh da khai trien cua dich
# `make sim-xif-kill` (xem tools/gen_filelists.py). DUNG SUA TAY: Makefile la
...
#     -f filelists/tb_xif_kill_wrap.f --top-module tb_xif_kill_wrap
include/ecg_pkg.sv
src/core/rtl/cv32e40x_if_xif.sv
src/soc/ecg_xif_bridge.sv
src/coproc/ecg_cvxif.sv
tb/tb_xif_kill_wrap.sv
