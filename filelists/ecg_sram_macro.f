# Tap nguon cua `ecg_sram_macro`, SINH RA tu dong lenh da khai trien cua dich
# `make sim-sram-macro` (xem tools/gen_filelists.py). DUNG SUA TAY: Makefile la
...
#     -f filelists/ecg_sram_macro.f --top-module ecg_sram_macro
asic/ecg_sram_macro.sv
